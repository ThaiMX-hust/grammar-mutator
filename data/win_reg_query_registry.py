rule_name=r"win_reg_query_registry"
...
#### 2. Query Registry with Powershell cmdlets
...
#### 3. Enumerate COM Objects in Registry with Powershell
...
#### 4. Reg query for AlwaysInstallElevated status
...
#### 5. Check Software Inventory Logging (SIL) status via Registry
...
#### 6. Inspect SystemStartOptions Value in Registry
